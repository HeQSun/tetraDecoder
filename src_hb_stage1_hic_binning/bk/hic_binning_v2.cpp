...
int main(int argc, char* argv[])
{
    ...
    cout << "   Info: summary on a0="                            << numraw                    
         ...
         << "         a1="                                       << num_pair_skip            
         << " reads skipped (including a11="                     << num_pair_intra
                      ...
                      string                     this_label)
{
    ...
    while(litr != litr_end)
    {
        ...
        unsigned long ctg1_size = target_contig_size[ keyinfo[0] ];     
        unsigned long ctg2_size = target_contig_size[ keyinfo[1] ];
        sofp << "\t"
             << keyinfo[0] << " -- " << keyinfo[1] << " "            
             ...
             << ctg2_size
             << ", "
             << this_cnt*1.0 / (ctg1_size+ctg2_size) * 100000
             << " */"  
             << endl;
        //
