...
int main(int argc, char* argv[])
{
    ...
    cout << endl;
    // step 6. cluster haplotigs
    cout << "   Info: step 6 - initial clustering of haplotigs using Hi-C link... " << endl;    
    ...
    cout << "   Info: step 6 - initial clustering of haplotigs using Hi-C link done. " << endl;        
    //
    ...
    while(cluster_edge.size() > N_cluster)
    {
        ...
        while(svitr != svitr_end)
        {
            ...
            while(vclitr != vclitr_end)
            {
                ...
                // TODO: check with allelic table, if the smaller and larger clusters should avoid being merged                
                // otherwise
                if( larger_cluster_id != smallest_cluster_id )
                {
                    ...
                    while(lvitr != lvitr_end)
                    {
                        ...
                        {
                            // cout << "   warning: no contact found for " << sctg << " - " << lctg << endl;
                        }                      
