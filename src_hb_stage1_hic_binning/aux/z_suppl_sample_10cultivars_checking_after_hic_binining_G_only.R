...
for(sample in c("G"))
{
  ...
  #
  min_cases <- c()
  # as chr03 does not give any phasing according to the general selection criteria, I did it with manual selection for chr03.
  for(chr in c("chr01", "chr02", "chr04", "chr05", "chr06", "chr07", "chr08", "chr09", "chr10", "chr11", "chr12"))
  #for(chr in "chr10")
  {
    # sample "O"
