...
for(sample in c("E"))
{
  ...
  #
  min_cases <- c()
  # as chr06 does not give any phasing according to the general selection criteria, I did it with manual selection for chr06.
  for(chr in c("chr01", "chr02", "chr03", "chr04", "chr05", "chr07", "chr08", "chr09", "chr10", "chr11", "chr12"))
  #for(chr in "chr10")
  {
    # sample "O"
