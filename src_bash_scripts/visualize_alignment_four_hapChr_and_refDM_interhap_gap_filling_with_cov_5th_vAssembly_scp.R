## this is setting up for visualizing alignment of chr to DM ref chr, with coverage analysis of chrs of 5th version of assembly
library(scales)
##
...
}else
{
  ...
  # out_prefix="A_chr01"
    ...
    for(hapi in haps)
    {
      ...
      {
        alignmraw2       <- read.table(paste(path, "/build_new_seq_from_old_", hapi, "/zcorrection_gap_corr_5th_refDM/", aln_file, sep=""))
      }
